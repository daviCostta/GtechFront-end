...
import ProductListing from '../components/AbaProdutos/productListingList';
...
const productsData = [
  { id: 1, name: "Nike Air Max 270", image: "https://images.yampi.io/unsafe/fit-in/1000x1000/filters:background_color(white):upscale()/https://images.yampi.me/assets/stores/mb-calcados4/uploads/images/air-max-270-pretopreto-design-minimalista-e-conforto-absoluto-38-67e0af754d92a-large.jpg", price: 200, priceDiscount: 149.9, category: "Tênis" },

  { id: 2, name: "Adidas Ultraboost", image: "https://static.polissport.com.br/public/polissport/imagens/produtos/media/tenis-adidas-ultraboost-5-6759efad44233.png", price: 200, category: "Tênis", priceDiscount: 180 },

  { id: 3, name: "Puma RS-X", image: "https://images.puma.com/image/upload/f_auto,q_auto,w_600,b_rgb:FAFAFA/global/394302/51/sv01/fnd/BRA/fmt/png", price: 99.9, category: "Tênis", priceDiscount: 89.9 },
  ...
  { id: 5, name: "Asics Gel Revelation", image: "https://carrefourbr.vtexassets.com/arquivos/ids/190405211/image-0.jpg?v=638803021463400000", price: 75, category: "Tênis" },
  { id: 6, name: "Reebok Classic Leather", image: "https://imgcentauro-a.akamaihd.net/660x660/M103OV01A5.jpg", price: 30, category: "Tênis" },
  { id: 7, name: "Vans Old Skool", image: "https://artwalk.vtexassets.com/arquivos/ids/221067-1200-auto?v=637178825850530000&width=1200&height=auto&aspect=true", price: 200, priceDiscount: 180, category: "Tênis" },
  { id: 8, name: "Converse Chuck Taylor", image: "https://converse.com.br/media/catalog/product/m/9/m9160c_a_08x1_1.png?optimize=high&bg-color=255,255,255&fit=bounds&height=&width=&format=jpeg", price: 250, category: "Tênis" },
  ...
  { id: 11, name: "Boné Lacoste", image: "https://oqvestir.fbitsstatic.net/img/p/calca-feminina-mom-jeans-azul-178657/463134.jpg?w=1600&h=2133&v=202501231556", price: 200, category: "Bonés" },
